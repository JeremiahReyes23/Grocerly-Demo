...
function initReceiptScanning() {
  ...
  const startLiveScanningSimulation = () => {
    ...
    const labels = ["MILK 1GAL", "EGGS 12CT", "CHICKEN BRST", "COSTCO WHOLESALE", "SUBTOTAL", "TAX", "TOTAL", "SPINACH", "AVOCADOS", "BREAD"];

    ocrLiveScanInterval = setInterval(() => {
      const box = document.createElement("div");
      box.className = "camera-ocr-highlight-box";
      
      const randomWidth = 20 + Math.random() * 25;
      ...
      box.setAttribute("data-label", `DETECTED: ${lbl}`);
      box.style.border = "1.5px solid var(--primary-green)";
      box.style.background = "rgba(46, 204, 113, 0.15)";
      box.style.position = "absolute";
      box.style.animation = "popAndFade 1.2s forwards ease-in-out";
