    ...
    card.innerHTML = `
      ...
      <div class="inv-card-main-content">
        ...
        <div class="inv-card-details-row" onclick="${clickAction}">
          <span class="inv-card-qty">
            ${item.currentQty} ${item.unit}
            <span style="font-size: 11px; font-weight: normal; color: ${getUsageProgressBarColor(item.remainingPercent)}; margin-left: 6px;">
      ...
      <div class="inv-card-progress-col" onclick="${clickAction}" title="${item.remainingPercent.toFixed(0)}% remaining">
        <div class="inv-card-progress-fill" style="height: ${item.remainingPercent}%; background: ${getUsageProgressBarColor(item.remainingPercent)};"></div>
      </div>
    `;
