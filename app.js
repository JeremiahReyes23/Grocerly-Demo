    ...
    card.innerHTML = `
      <div class="recipe-card-main-row">
        <div class="recipe-card-content">
          ...
          <div style="display: flex; flex-direction: column; gap: 4px; margin-bottom: 6px; font-size: 11px; color: var(--text-secondary);">
            <div><strong>Nutrition:</strong> Cal: ${recipe.nutrition.calories}kcal | P: ${recipe.nutrition.protein}g | C: ${recipe.nutrition.carbs}g | F: ${recipe.nutrition.fat}g</div>
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2px;">
              <span><strong>Servings:</strong> ${servingsAvailable > 0 ? `${servingsAvailable} times` : '<span style="color:var(--accent-orange); font-weight:700;">Out of Stock</span>'}</span>
