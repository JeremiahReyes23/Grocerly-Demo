...
function renderCalendarMealSlot(dateKey, mealType) {
  ...
  if (recipe) {
    ...
    return `
      <div class="calendar-meal-slot" onclick="openMealSelectorModal('${dateKey}', '${mealType}')" style="min-height: 72px; white-space: normal;">
        <span class="calendar-meal-slot-type" style="opacity: 0.6;">${mealType}</span>
        <span class="calendar-meal-slot-name" style="color: var(--text-secondary); font-size: 8px; white-space: normal;"><i class="fas fa-plus"></i> Add</span>
      </div>
    `;
  }
}
